...
3. Geliştirme sunucusunu çalıştırmak için:
...
4. Üretim için build (statik) dosyaları oluşturmak:

```bash
npm run build
# build/ klasörü oluşacaktır
```

5. Oluşan `build/` klasörünü bir statik sunucu üzerinden servis edebilirsiniz. Örn: proje kökünde `web313` altında sunmak için `web313/final-odevi/build/index.html` dosyasını işaret eden bir bağlantı oluşturun veya basit bir HTTP sunucusu kullanın:

```powershell
cd "C:\Users\zeyne\Desktop\web313"
